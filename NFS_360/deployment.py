...
ALLOWED_HOSTS = [os.environ.get('Hostname_Neucode', 'neucodewebapps-dfd5gae9aac4ayf4.eastus2-01.azurewebsites.net')]
CSRF_TRUSTED_ORIGINS = ['https://' + os.environ.get('Hostname_Neucode', 'neucodewebapps-dfd5gae9aac4ayf4.eastus2-01.azurewebsites.net')]
