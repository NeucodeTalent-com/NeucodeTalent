...
ALLOWED_HOSTS = [os.environ.get('Hostname_Neucode', 'ncprod-gnhjdyhgbpbphsem.eastus2-01.azurewebsites.net')]
CSRF_TRUSTED_ORIGINS = ['https://' + os.environ.get('Hostname_Neucode', 'ncprod-gnhjdyhgbpbphsem.eastus2-01.azurewebsites.net')]
